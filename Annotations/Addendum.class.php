...
use \wp\Annotations\DocComment\DocComment as DocComment;
...
class Addendum {
	...
	private static function checkRawDocCommentParsingNeeded() {
		if(self::$rawMode === null) {
			$reflection = new \ReflectionClass('\\wp\\Annotations\\Addendum');
	...
	public static function resolveClassName($class) {
		...
		$fullResult = "\\wp\\Annotations\\GlobalAnnotations\\" . $result;
