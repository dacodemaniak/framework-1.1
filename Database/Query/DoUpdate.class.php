<?php
/**
* @name DoUpdate ClassFactory pour la mise à jour de données à partir d'une Entité ou une Collection
...
abstract class DoUpdate {
	...
	public static function get(){
		$query = new \wp\Patterns\ClassFactory\DataUpdate();
		$query->getInstance();
