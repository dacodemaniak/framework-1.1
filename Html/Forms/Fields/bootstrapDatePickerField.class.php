<?php
/**
 * @name bootstrapDatePickerField.class.php Gestion d'un champ de type date avec sélection
...
class bootstrapDatePickerField extends \wp\Html\Forms\Fields\field {
	/**
