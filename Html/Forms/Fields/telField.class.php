<?php
/**
 * @name telField.class.php Instance d'un champ de type tel
...
class telField extends \wp\Html\Forms\Fields\field {
	/**
	...
	public function size($size=null){
		if(is_null($size)){
			return is_null($this->size) ? 14 : $this->size;
		}
		$this->size = $size;
		return $this;
	}
	...
	public function maxLength($maxLength = null){
		if(is_null($maxLength)){
			return is_null($this->maxLength) ? 14 : $this->maxLength;
		}
