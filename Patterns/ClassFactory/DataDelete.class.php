<?php
/**
 * @name DataDelete Factory spécifique pour la création d'un objet de requête de base de données
...
class DataDelete extends \wp\Patterns\ClassFactory\factory {
	/**
	...
	public function __construct(){
		...
		if($this->addInstance = $this->setClassName("\\wp\\Database\\" . $dbConnector->getProvider() . "\\Query\\Delete") != false){
			$this->addInstance();
		}
	}
