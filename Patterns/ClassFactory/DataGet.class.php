<?php
/**
 * @name DataGet.class.php Factory spécifique pour la création d'un objet de requête de base de données
...
class DataGet extends \wp\Patterns\ClassFactory\factory {
	/**
	...
	public function __construct(){
		...
		if($this->addInstance = $this->setClassName("\\wp\\Database\\" . $dbConnector->getProvider() . "\\Query\\Get") != false){
			$this->addInstance();
		}
	}
