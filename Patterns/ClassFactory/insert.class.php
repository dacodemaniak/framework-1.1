<?php
/**
 * @name insert.class.php Factory spécifique pour la création d'un objet de création de données de base de données
...
class insert extends \wp\Patterns\ClassFactory\factory {
	/**
	...
	public function __construct($activeRecord){
		...
		if($this->addInstance = $this->setClassName("\\wp\\Database\\" . $dbConnector->getProvider() . "\\Query\\insert") != false){
			$this->addInstance();
		}
	}
