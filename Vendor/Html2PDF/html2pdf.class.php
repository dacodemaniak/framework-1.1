 ...
 */
namespace wp\Vendor\Html2PDF;

require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/tcpdfConfig.php");
require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/locale.class.php");
require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/myPdf.class.php");
require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/parsingCss.class.php");
require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/parsingHtml.class.php");
require_once(\App\appLoader::wp()->getPathes()->getRootPath("wp") . "Vendor/Html2PDF/_class/exception.class.php");

use \wp\Vendor\Html2PDF\_class\HTML2PDF_locale;
use \wp\Vendor\Html2PDF\_class\HTML2PDF_exception;
use \wp\Vendor\Html2PDF\_class\HTML2PDF_myPdf;
use \wp\Vendor\Html2PDF\_class\HTML2PDF_parsingCss;
use \wp\Vendor\Html2PDF\_class\HTML2PDF_parsingHtml;
