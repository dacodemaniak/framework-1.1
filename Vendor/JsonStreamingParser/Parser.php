<?php
namespace wp\Vendor\JsonStreamingParser;
...
class Parser
{
    ...
    public function __construct($stream, $listener, $lineEnding = "\n", $emitWhitespace = false, $bufferSize = 8192)
    {
        ...
        if (!in_array("wp\\Vendor\\JsonStreamingParser\\Listener", class_implements(get_class($listener)))) {
            throw new \InvalidArgumentException("Listener must implement wp\\Vendor\\JsonStreamingParser\\Listener");
        }
